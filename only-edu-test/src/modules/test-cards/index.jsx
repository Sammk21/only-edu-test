...
const TestCards = () => {
  return (
    <div className="aspect-auto bg-[#f2f0f0]  rounded-2xl border shadow-sm p-5">
      <div className="flex justify-between">
        ...
        <div className="flex justify-around flex-col mt-4 text-sm">
          <button className="bg-[#fd7c22] text-white font-medium border py-2 px-2 rounded-lg">
            Start test
          </button>
          <button className="bg-[#d5d5d5] text-black font-medium border py-2 px-2 rounded-lg">
            Save the test
          </button>
        </div>
      </div>
