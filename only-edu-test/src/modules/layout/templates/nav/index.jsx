  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-[calc(100vw_-_3rem)] fixed top-4 inset-x-0 mx-auto  rounded-full  bg-white border-[1.5px] z-[5000] pr-2 pl-8 py-2  items-center justify-center space-x-4",
          className
        )}
      >
