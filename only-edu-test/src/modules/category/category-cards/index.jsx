...
const CategoryCard = ({ posts }) => {
  return (
    <div>
      <div className="aspect-square bg-[#115e5d] rounded-2xl border shadow-lg py-5 sm:px-5 px-3 text-white ">
        <div className=" h-full w-full flex flex-col gap-y-1">
          ...
          <div className="h-[60%] w-full bg-[#F5EFE6] rounded-lg text-[#115e5d]">
            <div className="py-2 ml-2 font-medium flex flex-col justify-center items-center ">
              <h3>{posts.title}</h3>
              <h5 className="text-xs ">
                <span>{posts.subTitle}</span>
              </h5>
              <h5 className="text-xs  mt-2">
                Test attempts: <span className="">{posts.TestAttempts}</span>
              </h5>
              <h5 className="text-xs ">
                Ranked youth: <span className="">{posts.rankedYouth}</span>
              </h5>
            </div>
            <div className=" p-4 mt-4 text-xs w-f items-center gap-x-2 flex justify-between">
              <div className="w-full">
                <Link className="w-full" href={"/testpage/1"}>
                  <button className="bg-[#115e5d]  w-full text-[#ededed] h-8 font-medium border border-gray-400 py-2 px-2  rounded-lg">
                    <span>View all</span>
                  </button>
                </Link>
              </div>
              <div>
                <Link href={"/testpage/1"}>
                  <button className="bg-[] text-[#115e5d] h-8 font-medium border border-gray-400 py-2 px-2  rounded-lg ">
                    <IoIosHeart />
                  </button>
                </Link>
              </div>
      ...
      {/* <div className="flex justify-between aspect-auto flex-col sm:flex-row">
          <div className="flex">
            ...
            <div className="py-2 ml-2 font-medium flex flex-col ">
              ...
              <h5 className="text-xs  mt-2">
                Test attempts: <span className="">97k+</span>
              </h5>
              <h5 className="text-xs ">
                Ranked youth: <span className="">50k+</span>
              </h5>
            </div>
          </div>
          <div className="flex mt-4 text-xs justify-center items-center gap-x-2 hidden sm:block">
            <span className="font-medium text-xs mr-2 ">34 more..</span>
