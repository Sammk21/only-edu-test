    ...
    <div className="py-7 flex justify-center">
      <div class="relative flex flex-col text-gray-700 bg-white shadow-sm w-96 rounded-xl bg-clip-border">
        ...
        <div class="p-6 pt-0">
          ...
          <p class="flex justify-center mt-6  text-sm antialiased font-light leading-normal text-[#115e5d]">
            Don't have an account?
            <Link
              href="/auth/register"
              class="block ml-1  text-sm antialiased font-bold leading-normal  text-[#fd7c22]"
            >
              Register
            </Link>
          </p>
